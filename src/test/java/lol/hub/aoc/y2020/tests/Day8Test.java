...
import lol.hub.aoc.y2020.day8.HandheldHalting1;
import lol.hub.aoc.y2020.day8.HandheldHalting2;
...
class Day8Test {
    ...
    private static final List<String> example = InputParser.stringList("inputs/2020/day8_example");
    private static final List<String> input = InputParser.stringList("inputs/2020/day8");

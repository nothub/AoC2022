...
import lol.hub.aoc.y2021.day3.BinaryDiagnostic1;
import lol.hub.aoc.y2021.day3.BinaryDiagnostic2;
...
class Day3Test {
    ...
    private static final List<String> example = InputParser.stringList("inputs/2021/day3_example");
    private static final List<String> input = InputParser.stringList("inputs/2021/day3");
